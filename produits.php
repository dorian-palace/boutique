...
<body>
    ...
    <main>
        ...
        $req_categories = $produits->sous_categorie();
        ...
        <div class="categorie">
            ...
            <?php
            if (isset($_GET['produits']) ||  isset($_GET['categorie']) ||isset($_GET['sous_categorie'])) { ?>
            ...
            ?>
                    <a href=" produits.php?categorie=<?= $req_categorie['categId'] ?>"><?= $req_categorie['nom_categorie'] ?></a>


                    <a href="produits.php?sous_categorie=<?= $req_categorie['id_sous_categorie'] ?>"><?= $req_categorie['nom_sous_categorie'] ?></a>
                        ...
                        <div class="container-produits">
                            ...
                            <div class="info-produit">
                                ...
                                <form action="#" method="post" class="add-panier">
                                    ...
                                    <a href="produits.php?categorie=<?= $req_categorie['categId'] ?>"><input type="submit" name='addpanier' value='Ajouter au panier' class="btn btn-success"></a>
                ...
                <?php
                } elseif (isset($_GET['categorie']) || isset($_GET['sous_categorie'])) {
                    ...
                    <div class="container row text-center offset-md-2 gap-3">
                        ...
                        <nav aria-label="Page navigation example">
                            ...
                            <li class="page-item">
                                ...
                                ?><a href="produits?categorie=<?= $req_categorie['categId'] ?>&page=<?= $i; ?>"><?= $i; ?></a>
                                <?php } ?>
                            </li>

                            <li class="page-item">
                                <?php if ($pagiCat < $nb_pageCat) { ?>
                                    <a href="produits?categorie=<?= $req_categorie['categId'] ?>&page=<?= $pagiCat + 1; ?>" class="page-link">></a>
                                <?php } ?>
                            </li>
